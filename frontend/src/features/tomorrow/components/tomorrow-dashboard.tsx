    ...
    <AppShell currentStep="분석" eyebrow="내일 분석">
      <div className="space-y-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <span className="status-pill w-fit text-brand">
            일정 부담 {demand}
          </span>
        </header>
        ...
        <section className="grid gap-4">
          <article className="glass-card rounded-[var(--radius-card)] p-6 sm:p-8">
            ...
            <div className="time-panel mt-8 p-5 sm:p-6">
        ...
        <section className="glass-card flex flex-col gap-4 rounded-[var(--radius-card)] p-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
