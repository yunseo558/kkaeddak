...
EXPECTED_OPERATIONS = {
    ...
    "/api/v1/wake-plans/{plan_id}/alarm-events": {"post"},
    "/api/v1/wake-plans/{plan_id}/decision": {"patch"},
    "/api/v1/wake-plans/{plan_id}/learning-effect": {"put"},
    "/api/v1/wake-plans/{plan_id}/report-context": {"put"},
    "/api/v1/wake-outcomes": {"post"},
    "/api/v1/history/reports": {"get"},
    "/api/v1/history/reports/{localDate}": {"get"},
